...
void main() {
  test('AppConfig.merge overrides only provided fields', () {
    ...
    expect(
      merged.api.endpoints.rbacGlobalRoleMembership,
      'custom/global-role-memberships',
    );
    expect(
    ...
    expect(
      mergedWithoutSuspendOverride.api.endpoints.rbacGlobalRoleMembership,
      defaults.api.endpoints.rbacGlobalRoleMembership,
    );
  ...
  test('default app definition owns built-in routes, settings, and roles', () {
    ...
    expect(shellRouteOrder, <String>[
      RouteIds.dashboard,
      RouteIds.chat,
      RouteIds.humanHandoff,
      RouteIds.tenantManagement,
      RouteIds.localUsers,
    ...
    String? drawerGroupFor(String routeId) =>
        definition.shellRoutes.firstWhere((route) => route.id == routeId).group;
    expect(drawerGroupFor(RouteIds.tenantManagement), 'Identity & Access');
    expect(drawerGroupFor(RouteIds.localUsers), 'Identity & Access');
    expect(
      drawerGroupFor(RouteIds.rolePermissionManagement),
      'Identity & Access',
    );
  ...
  test('shell route groups require a parent section', () {
    expect(
      () => ShellRouteDefinition(
        id: 'group-without-section',
        title: 'Grouped Route',
        icon: Icons.settings,
        group: 'Developer',
